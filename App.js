...
class Calculator extends Component {
  ...
  handleCalculate = () => {
    if (this.state.operator === '√') {
      ...
      this.setState((prevState) => ({
        input: prevState.input + '=',
        result: Math.sin(parseFloat(prevState.currentNumber)).toFixed(4),
        currentNumber: '',
        operator: '',
      }));
      ...
      this.setState((prevState) => ({
        input: prevState.input + '=',
        result: Math.cos(parseFloat(prevState.currentNumber)).toFixed(4),
        currentNumber: '',
        operator: '',
      }));
      ...
      this.setState((prevState) => ({
        input: prevState.input + '=',
        result: Math.tan(parseFloat(prevState.currentNumber)).toFixed(4),
        currentNumber: '',
        operator: '',
      }));
    } else {
